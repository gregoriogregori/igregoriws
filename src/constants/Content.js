export const HOME_CONTENT = {
  it: {
    title:
      "Dille che la ami!<br> dai Gregori un gioiello con diamanti <br> al di là dei suoi sogni",
    subtitle: "Italian fine jewellery",
    img: "/Gregori scritta.png",
    storia: {
  ...
  en: {
    title:
      "Tell her you love her!<br> Gregori's jewels with diamonds <br> beyond her dreams",
    subtitle: "Italian fine jewellery",
    img: "/Gregori_scritta_en.png",
    storia: {
      title: "Our History",
  ...
  ch: {
    title: "告诉她你爱她 Gregori <br> 的钻石珠宝 超越她的梦想",
    subtitle: "意大利高级珠宝",
    img: "/Gregori scritta.png",
    storia: {
      title: "我们的历史",
