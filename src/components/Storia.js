...
const sliderImages = [
  "/carosello-storia/Storia-3.png",
  "/carosello-storia/Storia-1.jpg",
  "/carosello-storia/Storia-2.png",
  "/carosello-storia/Storia-4.png",
];
  ...
  return (
    <section id="storia">
      <div className="container flex flex-col gap-8 max-w-6xl mx-auto mb-12 py-6 md:py-24 px-6 text-slate-800 md:flex-row">
        <Text
          tag="h2"
          className="text-4xl text-slate-950 font-medium  md:hidden text-center title-font "
        >
        ...
        <div className="md:w-[370px]">
          ...
          <div className="hidden md:flex mt-8">
            <Text className="title-font text-center text-slate-900   text-2xl">
        ...
        <div className="flex flex-col w-full md:w-[60%]">
          <div className="hidden md:block">
            <Text
              tag="h2"
              className="text-4xl font-medium title-font pb-4 text-slate-950 "
            >
              {content.storia.title}
            </Text>
            <div id="spacer" className="py-4 border-t-2 border-slate-950"></div>
          </div>
          <Text className="md:hidden mb-6 title-font text-center text-slate-900   text-2xl">
            {content.storia.subtitle}
          </Text>
