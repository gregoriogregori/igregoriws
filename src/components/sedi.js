...
const Sedi = () => {
    ...
    <div className="border-b border-yellow-600">
        ...
        <div className="flex flex-col md:flex-row justify-evenly p-8 h-[500px] text-xl">
            <div id="sedi1" className="h-96 md:w-[300px] flex items-end justify-end rounded-xl">
                <p className="bg-white bg-opacity-75 w-full text-center p-4">Via Marghera 22, Milano</p>
            </div>
            <div id="sedi2" className="h-96 md:w-[300px] flex items-end justify-end mt-4 md:mt-0 rounded-xl">
