...
const Features = () => {
    return ( 
        <section id="features">
            <div className="container flex flex-col gap-8 max-w-6xl mx-auto mb-12 mt-6 md:my-24 px-6 text-slate-800 md:flex-row cd:px-0 bg-white">
                ...
                <div className="w-full md:w-[370px]">
                    <Slider />
                    <div className="hidden md:flex mt-8 w-[90%]">
                        <p className="font-sans text-center text-slate-900 font-bold italic text-2xl">
